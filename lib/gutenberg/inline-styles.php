...
add_action( 'wp_enqueue_scripts', 'func_crossfit_custom_gutenberg_css' );
/**
 * Outputs front-end inline styles based on colors declared in config/block-editor-settings.php.
 *
 * @since 2.9.0
 */
function func_crossfit_custom_gutenberg_css() {
...
CSS;
	...
	$css .= func_crossfit_inline_font_sizes();
	$css .= func_crossfit_inline_color_palette();

	wp_add_inline_style( CHILD_THEME_HANDLE . '-gutenberg', $css );

}

add_action( 'enqueue_block_editor_assets', 'func_crossfit_custom_gutenberg_admin_css' );
/**
 ...
 * @since 2.9.0
 */
function func_crossfit_custom_gutenberg_admin_css() {
...
CSS;
	...
	wp_add_inline_style( 'crossfit-gutenberg-fonts', $css );
 ...
 */
function func_crossfit_inline_font_sizes() {
 ...
 */
function func_crossfit_inline_color_palette() {
