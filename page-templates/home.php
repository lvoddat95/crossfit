...
?>
            ...
            <div class="row">
                <div class="col-md-12 col-xs-12 col-sm-12">
                    <div class="section-title hm-section-2-title text-center text-uppercase">
                        <h2 class="title51 font-montse no-margin"><?php if ($s_welcome['hm_section2_title1']) echo esc_html($s_welcome['hm_section2_title1']); ?></h2>
                        <h3 class="title51 font-bold font-montse no-margin"><?php if ($s_welcome['hm_section2_title2']) echo esc_html($s_welcome['hm_section2_title2']); ?></h3>
                    </div>
                </div>
    ...
    <div class="hm-section-5"
         style="background:url('http://localhost/crossfit/wp-content/uploads/2019/05/testimonial-bg-1.jpg')">
        <div class="container">
            <div class="row">
                <div class="col-md-12 col-xs-12 col-sm-12">
